...
Use the included Unraid XML template to deploy. New builds should use the pinned published image tag `ghcr.io/rzrnaz/immich-tagger-public:v1.0.7-unraid1` rather than `latest`.
